        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-3xl font-black text-gray-900 mb-2">Admin Reset Password</h1>
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex-1 text-center">
                            ...
                            <p class="text-xs mt-2 text-gray-500 font-bold">Verify OTP</p>
                        </div>
                        ...
                        <div class="flex-1 text-center">
                            ...
                            <p class="text-xs mt-2 text-gray-500 font-bold">New Password</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="step1" class="step-content">
                    <h2 class="text-xl font-black text-gray-900 mb-6">Step 1: Enter Phone Number</h2>
                ...
                <div id="step2" class="step-content hidden">
                    <h2 class="text-xl font-black text-gray-900 mb-4">Step 2: Verify OTP</h2>
                    ...
                    <form id="otp-form" class="space-y-6">
                        ...
                        <div class="flex gap-3">
                            <button type="button" class="btn btn-secondary flex-1" onclick="goToStep(1)">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="step3" class="step-content hidden">
                    <h2 class="text-xl font-black text-gray-900 mb-6">Step 3: Set New Password</h2>
                    ...
                    <form action="{{ route('admin.reset-password.submit') }}" method="POST" class="space-y-6" id="reset-form">
                        ...
                        <div class="flex gap-3 pt-4">
                            <button type="button" class="btn btn-secondary flex-1" onclick="goToStep(2)">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                                </svg>
                                Back
                            </button>
                            <button type="submit" class="btn btn-primary flex-1" id="reset-submit-btn">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                </svg>
                                Reset Password
                ...
                <div class="mt-6 text-center text-sm text-gray-600">
                    <p>
                        ...
                        <a href="{{ route('admin.login') }}" class="text-wash hover:text-wash-dark font-bold hover:underline transition-colors">
                            Sign in here
                        </a>
                    </p>
                </div>

<x-layout>
    ...
    <div data-send-otp-url="{{ route('admin.send-password-reset') }}"
         data-verify-otp-url="{{ route('admin.verify-password-reset') }}"
         data-reset-password-url="{{ route('admin.reset-password') }}"
        ...
        <div class="w-full max-w-2xl">
            <x-modules.card class="shadow-xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Recover your admin account access</p>
                </div>
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div class="flex-1 text-center">
                            ...
                            <p class="text-sm mt-2 font-semibold text-blue-600">Phone Number</p>
                        </div>
                ...
                <div id="step2" class="step-content hidden">
                    ...
                    <form id="verify-otp-form" class="space-y-4">
                        ...
                        <div class="text-center">
                            <button type="button" id="resend-otp" onclick="resendOTP()" class="text-blue-600 hover:text-blue-700 font-medium text-sm">
                                Resend OTP
                            </button>
                        </div>
                    </form>

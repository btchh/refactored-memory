<x-layout title="Track Shop Locations">
    ...
    <div class="min-h-screen bg-gray-50">
        <div class="container mx-auto px-4 py-8">
            <div class="mb-6">
                <h1 class="text-4xl font-bold text-gray-900 mb-2">Route to Shop</h1>
                <p class="text-gray-600">Track your laundry shops and plan your route</p>
            </div>
                    ...
                    <div id="route-info" class="bg-white rounded-lg border border-gray-200 p-6 hidden">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                <p class="text-sm text-gray-600 mb-1">Shop</p>
                                <p class="font-semibold text-gray-900" id="shop-name">-</p>
                                <p class="text-sm text-gray-500" id="shop-address">-</p>

    ...
    <div class="max-w-2xl w-full">
        ...
        <div class="relative bg-gradient-to-br from-wash via-wash-dark to-gray-900 rounded-2xl p-12 overflow-hidden mb-8">
            ...
            <div class="relative text-center">
                ...
                <h1 class="text-7xl md:text-8xl font-black text-white mb-4">500</h1>
                <h2 class="text-2xl md:text-3xl font-black text-white mb-3">Server Error</h2>
                <p class="text-lg text-white/80">Something went wrong on our end. Please try again later.</p>
            </div>
        </div>

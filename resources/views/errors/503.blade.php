...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        ...
        <p class="text-gray-500 mb-8">We're performing scheduled maintenance. We'll be back shortly!</p>
        <div class="text-sm text-gray-400">Please check back in a few minutes.</div>
    </div>
</body>
</html>

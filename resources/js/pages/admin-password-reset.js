...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const routes = {
        sendPasswordResetOtp: window.routes?.sendPasswordResetOtp || '/admin/send-password-reset-otp',
        verifyPasswordResetOtp: window.routes?.verifyPasswordResetOtp || '/admin/verify-password-reset-otp'
    };
